...
import { addParent } from "../../utils/ApiFunctions";
...
const AddParent = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const response = await addParent(parent);
    ...
    if (response.status === 201) {
      setSuccessMessage("The Parent added successfully!");
    } else {
    ...
    <div className="content container-fluid">
      ...
      <div className="page-header">
        <div className="row align-items-center">
          <div className="col">
            <h3 className="page-title">Add Parent</h3>
            <ul className="breadcrumb">
              <li className="breadcrumb-item">
                <Link to="/parents">Parents</Link>
              </li>
              <li className="breadcrumb-item active">Add Parent</li>
            </ul>
          </div>
        </div>
      </div>
