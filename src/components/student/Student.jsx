...
import { deleteStudentById } from "../../utils/ApiFunctions";
...
const Student = () => {
  ...
  const deleteStudentHandler = async (event, id) => {
        ...
        <div className="col-sm-12">
          <div className="card card-table">
            <div className="card-body">
              ...
              {data.content.length > 0 && data.content[0].id !== "" && <div className="table-responsive">
                <div
                              ...
                              <td className="text-end">
                                <div className="actions">
                                  ...
                                  {localStorage.getItem("role") ===
                                    ...
                                    <>
                                      <Link
                                        to={`/update-student-by-id/${student.id}`}
                                      ...
                                      >
                                        <i
                                          ...
                                          onClick={(event) =>
                                            deleteStudentHandler(event, student.id)
                                          }
                                        />
                                      </a>
                                    </>
