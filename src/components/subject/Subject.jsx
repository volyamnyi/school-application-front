...
import { deleteSubjectById } from "../../utils/ApiFunctions";
...
const Subject = () => {
  ...
  useEffect(() => {
    getAllSubjects(currentPage, elementsPerPage).then((data) => {
      setData(data);
    });
  }, [subjectId, currentPage, elementsPerPage]);
  ...
  const deleteSubjectHandler = async (event, id) => {
                                    ...
                                    <td className="text-end">
                                      <div className="actions">
                                        ...
                                        {(ROLE === "SUPER_ADMIN" ||
                                          ...
                                          <>
                                            <Link
                                              to={`/update-subject-by-id/${subject.id}`}
